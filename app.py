...
user_input['Diet_Type'] = st.selectbox("Tipo de dieta", ['Balanced', 'High-Fat', 'High-Protein', 'Low-Carb', 'Vegan', 'Vegetarian'])
user_input['Exercise_Frequency'] = st.selectbox("Frecuencia de ejercicio", ['Rarely', 'Occasionally', 'Regularly'])
